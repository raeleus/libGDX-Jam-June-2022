...
/**
 * Modified by Raeleus to make fields public and not depend on JavaFX.
 */
public class HexUtils {
    public final Orientation orientation;
    public final Vector2 size;
    public final Vector2 origin;
    public enum TYPE {EVENR,ODDR,EVENQ,ODDQ}
    public enum STRETCH {HORIZONTAL,VERTICAL}
    public enum SHAPE {RECTANGLE, TRIANGLE, HEXAGON, RHOMBUS}
...
class Pair<K, V> {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$item1 = this.getKey();
        final Object other$item1 = other.getKey();
        if (this$item1 == null ? other$item1 != null : !this$item1.equals(other$item1)) return false;
        final Object this$item2 = this.getValue();
        final Object other$item2 = other.getValue();
        if (this$item2 == null ? other$item2 != null : !this$item2.equals(other$item2)) return false;
        return true;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final Object $item1 = this.getKey();
        result = result * PRIME + ($item1 == null ? 43 : $item1.hashCode());
        final Object $item2 = this.getValue();
        result = result * PRIME + ($item2 == null ? 43 : $item2.hashCode());
        return result;
    }
    
    public String toString() {
        return "Pair(item1=" + this.getKey() + ", item2=" + this.getValue() + ")";
    }
}